    ...
    <div class="bg-slate-800/50 border border-white/5 rounded-2xl overflow-hidden backdrop-blur-sm shadow-xl">
        <form action="{{ route('hr-manager.recruitment.store') }}" method="POST">
            ...
            <div class="p-8 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="title" required class="w-full bg-slate-900 border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent placeholder-slate-600">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="location" required placeholder="e.g. Douala, Cameroon" class="w-full bg-slate-900 border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>

                    <div>
                        <label class="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-2">Salary Range</label>
                        <input type="text" name="salary_range" placeholder="e.g. 150k - 200k FCFA" class="w-full bg-slate-900 border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>
                </div>

                <!-- Rich Text (Simple textareas for now) -->
                <div>
                    <label class="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-2">Description</label>
                    <textarea name="description" rows="5" required class="w-full bg-slate-900 border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"></textarea>
                </div>

                <div>
                    <label class="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-2">Requirements</label>
                    <textarea name="requirements" rows="4" class="w-full bg-slate-900 border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"></textarea>
                </div>

                <div>
                    <label class="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-2">Benefits</label>
                    <textarea name="benefits" rows="3" class="w-full bg-slate-900 border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"></textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-white/5">
                    ...
                    <div>
                        ...
                        <input type="date" name="closing_date" class="w-full bg-slate-900 border-white/10 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>
                </div>
            </div>
            ...
            <div class="px-8 py-5 bg-slate-900 border-t border-white/5 flex justify-end gap-4">
                ...
                <button type="submit" class="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-bold transition-colors shadow-lg shadow-indigo-500/20">Create Job Posting</button>
            </div>
        </form>
    </div>
</div>
